...
![image-20201219160934257](./frp搭配nginx将https请求映射到内网.assets/20201219163456.png)

我们之前使用 frp 将内网服务映射出去后只能提供 http 协议的形式访问，无法使用 https 协议，这个怎么办呢？

经过一番资料查找，发现需要搭配 nginx 一起使用就可以解决。
![image-20230218223202953](./frp搭配nginx将https请求映射到内网.assets/image-20230218223202953.png)
