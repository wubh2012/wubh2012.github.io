...
![image-20201105213254604](在windows上设置frp开机自动启动.assets/20201106173532.png)
...
![image-20201105213622063](在windows上设置frp开机自动启动.assets/20201106173550.png)

![image-20201105213739577](在windows上设置frp开机自动启动.assets/20201106173557.png)

2. 执行之后会显示下面这个页面，选择 frpc 程序的路径，以及启动的参数

![image-20201105213843898](在windows上设置frp开机自动启动.assets/20201106173601.png)

![image-20201105214258612](在windows上设置frp开机自动启动.assets/20201106173603.png)

3. 填写服务的显示名称以及服务说明，还有启动方式，默认是自动自动

![image-20201105214507281](在windows上设置frp开机自动启动.assets/20201106173606.png)

4. 配置程序输入和输出日志存放位置（可选）

   ![image-20201105215008339](在windows上设置frp开机自动启动.assets/20201106173609.png)
...
![image-20201105215255665](在windows上设置frp开机自动启动.assets/20201106173612.png)



![image-20201105215411888](在windows上设置frp开机自动启动.assets/20201106173615.png)
